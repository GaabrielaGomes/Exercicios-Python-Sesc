#23. O proprietário de um restaurante deseja informatizar o seu estabelecimento, para tanto você foi contratado com o seguinte propósito. Elabore um algoritmo que leia o número da mesa e qual a quantidade dos itens consumidos de um determinado cardápio, para que se possa saber o valor total desta mesa (conta), o algoritmo deverá prever a entrada do número de pessoas existentes na mesa para que seja feita a divisão da mesma, entre os seus ocupantes.
# Cardápio:
# Refrigerante 1.20
# Cerveja 1.50
# Almoço 6.30
