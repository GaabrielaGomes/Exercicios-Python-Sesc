#24. A Empresa ABC produz 3 tipos de peças mecânicas: parafusos, porcas e arruelas. Sabe-se que é dado desconto de: 10% por porca vendida, 20% por Arruelas vendidas, 30% por parafusos vendidos. Dados de Entrada: nome do cliente; preço unitário da porca, arruela, parafuso; quantidade de porcas, arruelas e parafusos solicitados pelo cliente. Dados de Saída: nome do cliente; número de porcas, arruelas e parafusos comprados; total pago pelas porcas, arruelas e parafusos; total de desconto dado ao cliente; total a ser pago pelo cliente.
#Resposta:
