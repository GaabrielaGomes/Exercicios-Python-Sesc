#15. A importância de R$ 780.000,00 será dividida entre os três primeiros colocados de um concurso, em partes diretamente proporcional aos pontos conseguidos por eles. Construa um programa que leia o numero de pontos dos três primeiros colocados e imprima a importância que caberá a cada um deles.
#Resposta
